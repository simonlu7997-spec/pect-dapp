...
const tokenDistribution = [
  ...
  { name: "公募", value: 50, color: "#06b6d4" },
  { name: "生态基金", value: 5, color: "#f59e0b" },
  { name: "团队", value: 10, color: "#ef4444" },
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b-2 border-gray-300 bg-gray-100">
                  ...
                  <th className="text-right py-3 px-4 font-semibold text-gray-700">年发电量</th>
                  <th className="text-right py-3 px-4 font-semibold text-gray-700">年收入</th>
                </tr>
              </thead>
              <tbody>
                {stationsLoading ? (
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700">满足监管机构要求</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-emerald-600 font-bold text-xl">✓</span>
      ...
      <section className="py-16 bg-gradient-to-r from-indigo-600 to-purple-600">
        <div className="container max-w-6xl">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-white mb-3">加入 PECT 社区</h2>
            <p className="text-indigo-200 text-lg">与全球投资者一起探讨绿色能源与区块链的未来</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
            ...
            <a
              ...
              className="flex items-center gap-4 bg-white/10 hover:bg-white/20 border border-white/20 rounded-2xl p-6 transition-all group"
            >
              ...
              <div>
                <p className="text-white font-semibold text-lg group-hover:text-indigo-100">加入 Discord</p>
                <p className="text-indigo-200 text-sm">实时交流 · 社区讨论</p>
              </div>
            </a>
            ...
            <a
              ...
              className="flex items-center gap-4 bg-white/10 hover:bg-white/20 border border-white/20 rounded-2xl p-6 transition-all group"
            >
              <div className="w-12 h-12 bg-[#229ED9] rounded-xl flex items-center justify-center shrink-0">
                <svg viewBox="0 0 24 24" className="w-7 h-7 fill-white">
                  <path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.48.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z"/>
                </svg>
              </div>
              <div>
                <p className="text-white font-semibold text-lg group-hover:text-indigo-100">加入 Telegram</p>
                <p className="text-indigo-200 text-sm">最新公告 · 项目动态</p>
              </div>
            </a>
          </div>
        </div>
