...
const faqs: Array<{ q: string; a: string | string[] }> = [
  ...
  },
  {
    ...
    a: "首先在 DApp 中连接钉包，然后进入购买页面。选择要购买的代币类型和数量，确认交易即可。需要注意的是，只有白名单成员才能购买 PV-Coin。C2-Coin 不用购买，按 PV-Coin 持有数量每月空投。"
  },
  {
    q: "最少购买数量是多少？",
  ...
  },
  {
    q: "空投如何计算？",
    a: [
      "C2-Coin 空投根据您持有的 PV-Coin 数量按比例分配。电站每年根据实际发电量铸造约 382,990 枚 C2-Coin。",
      "计算公式：",
